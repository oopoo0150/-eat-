...
public class ProductManagement {
	...
	/*
	 * //파일 다운로드 public void downLoadP(Map<String, Object> params) throws Exception{
	 * String dbi_oriName = (String)params.get("dbi_oriName"); String dbi_sysName =
	 * (String)params.get("dbi_sysName"); String root = (String)params.get("root");
