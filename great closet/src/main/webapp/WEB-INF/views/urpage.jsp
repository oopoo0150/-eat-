				...
				<div id="mypage_top">
					...
					<div id="uinfo">
						<div id="uinfo_top">
							...
							<div class="">
									<input type="button" value="차단하기" id="blockbtn" onclick="blockbtn_clicked()">	
									<input type="hidden" name="uid" value="${uid}"> 							
							</div>
							<div class="">
								<form action="followUr">
									<input type="button" value="팔로우하기" id="followbtn" onclick="followbtn_clicked()">
								</form>
							</div>
						</div>
						<div id="uinfo_bottom">
