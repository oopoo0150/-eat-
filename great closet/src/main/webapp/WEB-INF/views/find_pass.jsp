...
<div id="h_bottom">
	...
	<form action="./findedPASS" method="post">
		<input type="text" id="s_name" name="s_name" placeholder="이름 입력" required="required"><br>
		<input type="text" id="s_id" name="s_id" placeholder="아이디 입력" required="required"><br>
		<input type="email" id="s_mail" name="s_mail" placeholder="메일 입력" required="required"><br>
