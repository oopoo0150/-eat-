...
<div id="h_bottom">
	...
	찾으시는 ${mb.s_name}님의 아이디는 ${mb.s_id} 입니다.!!<br>
	<input type="button" value="비밀번호 찾으로 가기" onclick="location.href='./findpass'">
	<input type="button" value="로그인 하러 가기" onclick="location.href='./login'">
