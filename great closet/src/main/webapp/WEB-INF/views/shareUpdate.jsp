		...
		<div align="center">
			<form action="swriteInsert" method="post" name="shareAdd" enctype="multipart/form-data">
				<table>
					<tr height="35">
						...
						<input type="hidden" id="fileCheck" value="0" name="fileCheck" /></td>
						 ...
						 <div id='View_area' 
							...
							<div id = "upimg">
								<img src = "./resources/files/${share.sb_sysname}" height="100" width="100">
							</div>
						</div>
					...
					<tr height="35">
						<td>제목</td>
						<td><input type="text" id="sb_title" name="sb_title"
							required="requred" value="${share.sb_title}"></td>
					</tr>

					<tr>
						<td>내용</td>
						<td><textarea id="sb_content" name="sb_content" rows="15" cols="80"
								required="required">${share.sb_content}</textarea> <!-- 해당 에디터 적용 --> <script>
				...
				<input type="hidden" id="sb_num" name="sb_num" value="${share.sb_num}">
...
<script>
  ...
  //ie가 아닐때(크롬, 사파리, FF)
	...
	function formdata() {
		...
		fData.append("sb_num", $("#sb_num").val());
