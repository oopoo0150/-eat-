...
<body>
	...
	<center>
					<form  action="imgUpdateform" method = "post"> 
		<table>
			<tr>
				...
				<div>
				<center>
				<img src="./resources/files/${cldImg.cld_sysname}" width="100" height="100" />
				<input type = "hidden" value = "${cldImg.cld_sysname}" name = "cld_sysname">
				</center>
				</div>
				</td>
			...
			<tr height="30">
				...
				<td>${cldImg.cld_color}
				<input type = "hidden" value = "${cldImg.cld_color}" name = "cld_color">
				</td>
			</tr>
			...
			<tr height="30">
				...
				<td>${cldImg.cld_size}
				<input type = "hidden" value = "${cldImg.cld_size}" name = "cld_size">
				</td>
			</tr>
			...
			<tr height="30">
				...
				<td>${cldImg.cld_season}				
				<input type = "hidden" value = "${cldImg.cld_size}" name = "cld_season">
				</td>
			</tr>
			...
			<tr height="30">
				...
				<td>${cldImg.cld_amount}
				<input type = "hidden" value = "${cldImg.cld_amount}" name = "cld_amount">
				</td>
			</tr>
			...
			<tr height="80">
				...
				<td> ${cldImg.cld_content}
				<input type = "hidden" value = "${cldImg.cld_content}" name = "cld_content">
				</td>
			</tr>

				<input type = "hidden" value = "${cldImg.cld_num}" name = "cld_num">
		</table>
		...
		<br>		
			...
			<a href= "./imgDelete?cld_num=${cldImg.cld_num}">
...
function previewImage(targetObj, View_area) {
  ...
  //ie가 아닐때(크롬, 사파리, FF)
	...
	function formData() {
		...
		fData.append("cld_clnum", $("#cld_clnum").val());
		...
		$.ajax({
			...
			success : function(data) {
				alert("성공");
				location.href = "./imgList?cl_num=${cl_num}";
				console.log(data);
			},
