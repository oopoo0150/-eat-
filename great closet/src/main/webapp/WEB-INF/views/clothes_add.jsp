...
<body>
	...
	<form action="ClothesimgAdd" enctype="multipart/form-data">
		<table>
			<tr>
			...
			<tr height="30">
				...
				<td><input type="text" name="cld_size" id = "cld_size" required/></td>
			</tr>
			...
			<tr height="30">
				...
				<td><input type="text" name="cld_amount" id = "cld_amount" required/></td>
			</tr>

			<tr height="80">
				<td>메모 : </td>

				<td><textarea rows="5" style="width:130px" name="cld_content"  id = "cld_content" required> </textarea></td>
			</tr>

		</table>
		
			<input type = "hidden" value = "${cl_num}" name="cld_clnum" id = "cld_clnum"/>
