...
public class Paging {
	...
	public Paging(int maxNum, int pageNum, int listCount, int pageCount, String boardName, String table, String cate) {
		this.maxNum = maxNum;
